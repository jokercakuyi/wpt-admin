...
module.exports = {
  ...
  systemName: '文版通管理后台',         //系统名称
  copyright: '2021 私域生态系统',     //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    {link: 'https://www.equnshang.com', name: '官网首页'},
    {link: 'https://www.equnshang.com', icon: 'home'},
    {link: 'https://www.equnshang.com', name: '私域生态系统'}
  ],
}
